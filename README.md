...
|------|---------|-------------|
| `--dry-run` | `false` | Show which files would be annotated without modifying anything |
...
1. **Scan** — `scanner.Walk` collects all files matching your configured `extensions`, respecting `ignore` patterns.
